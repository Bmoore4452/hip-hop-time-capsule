    ...
    answers: [
      {
        questionNumber: 5,
        questionText:
          'Who are (or were) your hottest (or as we used to say "illest") MCs?',
        answerText:
    ...
    answers: [
      {
        ...
        answerText:
          "No. Hip-Hop did not play a major role in my friendship or social circles.",
      },
      {
        questionNumber: 8,
        questionText:
  ...
  // ── Page 149 ────────────────────────────────────────────────────────────────
  {
    ...
    answers: [
      ...
      },
      {
        questionNumber: 10,
        questionText:
          "Who are (or were) the top DJs who made the biggest impact on Hip-Hop?",
        answerText:
    ...
    answers: [
      {
        questionNumber: 11,
        questionText:
          "Who, from your crew, are (or were) your favorite people to party with?",
        answerText:
  ...
  // ── Page 152 ────────────────────────────────────────────────────────────────
  {
    ...
    answers: [
      ...
      },
      {
        questionNumber: 16,
        questionText:
          'In your day, who were the hottest (we used to say "illest") top five male artists or groups?',
        answerText:
          'The "illest" top five male artists were Tupac, Snoop Dogg, Run-DMC, LL Cool J and Eric B. & Rakim',
      },
    ],
  },
  ...
  // ── Page 153 ────────────────────────────────────────────────────────────────
  {
    ...
    answers: [
      ...
      },
      {
        questionNumber: 18,
        questionText:
          "What are some old-school lines or quotes that you still quote today?",
        answerText:
    ...
    answers: [
      {
        questionNumber: 19,
        questionText:
          "What are (or were) your favorite songs to be played at a club?",
        answerText:
    ...
    answers: [
      {
        questionNumber: 39,
        questionText:
          "When was the first time (if ever) you tried to write your own rap?",
        answerText:
    ...
    answers: [
      {
        ...
        answerText:
          "Hmmm. I'll have to think about that... please, don't hold your breath. :)",
      },
      {
        questionNumber: 48,
        questionText:
    ...
    answers: [
      {
        questionNumber: 58,
        questionText:
          "If you chose a career in Hip-Hop, what were some of the challenges you faced?",
        answerText:
    ...
    answers: [
      {
        questionNumber: 73,
        questionText:
          "As classic Hip-Hop has evolved, what artists or groups do you feel have positively impacted the music?",
        answerText:
    ...
    answers: [
      {
        ...
        answerText:
          "No rapper influenced me to become or want to become a rapper.",
      },
      {
        questionNumber: 80,
        questionText:
  ...
  // ── Page 205 ────────────────────────────────────────────────────────────────
  {
    ...
    answers: [
      ...
      },
      {
        questionNumber: 89,
        questionText:
          "In your generation, was your favorite graffiti artist? Do you have a favorite today?",
        answerText:
...
export function getAnitaScipioPage(
  pageNumber: number,
): AnitaPageData | undefined {
