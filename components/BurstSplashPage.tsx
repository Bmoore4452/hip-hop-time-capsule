...
interface BurstSplashPageProps {
  pageNumber: number;
  // Lines of gold text shown centered inside the star burst.
  lines: string[];
}
...
export default function BurstSplashPage({ pageNumber, lines }: BurstSplashPageProps) {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.burstWrapper}>
          ...
          <View style={[styles.burstTextOverlay, { width: burstSize, height: burstSize }]}>
            {lines.map((line, i) => (
              <Text key={i} style={styles.burstName}>{line}</Text>
            ))}
          </View>
        </View>
