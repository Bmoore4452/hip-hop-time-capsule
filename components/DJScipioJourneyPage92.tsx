...
interface DJScipioJourneyPage92Props {
    pageNumber: number;
}

export default function DJScipioJourneyPage92({ pageNumber }: DJScipioJourneyPage92Props) {
    return (
                ...
                <View style={styles.contentContainer}>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.inputDisplay}>
                            <Text style={styles.inputText}>HILTON SCIPIO</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.inputDisplay}>
                            <Text style={styles.inputText}>PRIVATE</Text>
                        </View>
                    </View>
